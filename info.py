...
# Bot information
SESSION = environ.get('SESSION', 'DevNkBot')
API_ID = int(environ.get('API_ID', '28192191'))
API_HASH = environ.get('API_HASH', '663164abd732848a90e76e25cb9cf54a')
BOT_TOKEN = environ.get('BOT_TOKEN', "7645408682:AAGvc1RTcI1w4gDPnavHae_oZvJpeiNHIv8")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1676244457').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 'https://t.me/+EzrR7Tqx9ZBlMTc9'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002148258712').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001794747387') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002474111098')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002258747484').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://phnixsparrow:sabishnu@cluster0.lvdj9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Scorpscollection')

MULTIPLE_DATABASE = bool(environ.get('MULTIPLE_DATABASE', False)) # Set True or False

# If Multiple Database Is True Then Fill All Three Below Database Uri Else You Will Get Error.
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://hamsterphnix:_P73qjrFMQQMk7b@amazon.daj32.mongodb.net/?retryWrites=true&w=majority&appName=amazon")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://demonstork:mu5zYibmvf.tJWi@gooles.fi72j.mongodb.net/?retryWrites=true&w=majority&appName=gooles")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://sevensdegger:_G5y_hg4ajVGj_7@tracker.adpmw.mongodb.net/?retryWrites=true&w=majority&appName=tracker")   # This Db is for File Data Store When First Db Is Going To Be Full.
